...
<div class="nsl-admin-sub-content">
    ...
    <?php else: ?>
        ...
        <ol>
            <li><?php _e('Make sure you have an <strong>active subscription for the Apple Developer Program</strong>!', 'nextend-facebook-connect'); ?></li>
        ...
        <ol>
            ...
            <li><?php _e('Tick the "<b>Sign In with Apple</b>" option and click the "<b>Configure</b>" button next to it.', 'nextend-facebook-connect'); ?>
                <ol>
                    ...
                    <li><?php printf(__('Add the following URL to the "<b>Return URLs</b>" field: <b>%s</b>', 'nextend-facebook-connect'), $provider->getLoginUrl()); ?></li>
                </ol>
            </li>
            <li><?php _e('Save the configuration by clicking on the "<b>Save</b>" button and pressing "<b>Done</b>".', 'nextend-facebook-connect'); ?></li>
