...
class Notifications
{
    ...
    static public function php_requirement_notice() {
        if (!rtwpvs()->is_valid_php_version()) {
            ...
            $message = wp_kses(__("It's required to use latest version of PHP to use <strong>Variation Swatches for WooCommerce</strong>.", 'woo-product-variation-swatches'), array('strong' => array()));
    ...
    static public function wc_requirement_notice() {
        if (!rtwpvs()->is_wc_active()) {
            ...
            $message = wp_kses(__("<strong>Variation Swatches for WooCommerce</strong> is an add-on of ", 'woo-product-variation-swatches'), array('strong' => array()));
