...
class Xoo_Aff_Options_Callbacks {
	...
	public function multiple_checkboxes( $args ){
		...
		<?php foreach ($options as $option): ?>
			<input type="checkbox" class="xoo-input-multiple-cb" id="<?php echo $id; ?>" name="<?php echo $id.'[]'; ?>" value="<?php echo $option['value']; ?>" <?php echo in_array( $option['value'], (array) $value ) ? 'checked' : null; ?>>
			<span class="xoo-el-mcb-label"><?php echo $option['title']; ?></span>
		<?php endforeach; ?>
		<?php
	}
